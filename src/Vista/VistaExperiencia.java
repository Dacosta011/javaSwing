 ...
 * @author USER
 */
public class VistaExperiencia extends javax.swing.JFrame implements ActionListener
{
    ...
    private GestionExperiencia ge;
     public VistaExperiencia() {
        initComponents();
        
        this.ge=new GestionExperiencia();
    ...
    {
        //proceso de guardar:
        String id,tie,emp,car;
        boolean ok;
        
        id=this.jTextField1.getText();
        tie=this.jTextField2.getText();
        emp=this.jTextField3.getText();
        car=this.jTextField4.getText();
        
        Experiencia experiencia=new Experiencia(id,tie,emp,car);
        
        ok=this.ge.guardaExperiencia(experiencia);
        if(ok)
        {
    ...
    public void actionPerformed(ActionEvent e) 
    {
       if(e.getSource()==this.jButton1)
        ...
        if(e.getSource()==this.jButton2)//Crear Nuevo
        {
            new VistaCargo();
        }
        if(e.getSource()==this.jButton3)//Crear Nuevo
        {
            this.guardar();
        }
        if(e.getSource()==this.jButton6)//Crear Nuevo
        {
